...
namespace com.wer.sc.graphic
{
    public interface GraphicDrawerHelper
    {
        ...
        //void Run(Plugin_KLineModel model);

        //void Run(IKLineData data, Plugin_KLineModel model);

        //void Run(String code, int start, int end, KLinePeriod period, Plugin_KLineModel model);
    }

...
namespace com.wer.sc.strategy
{
    ...
    {
        public static IStrategyExecutor CreateHistoryExecutor(IDataPackage dataPackage, StrategyReferedPeriods referedPeriods, ForwardPeriod forwardPeriod, StrategyHelper strategyHelper)
        {

...
{
    public class StrategyTrader_HistoryBak : IStrategyTrader
    {
        private StrategyTrader_Account strategyTrader;

        private string code;

        private bool autoFilter;

        public StrategyTrader_HistoryBak(StrategyTrader_Account strategyTrader, string code)
        {
        ...
        {
            CloseAll(code, OrderSide.Buy);
            CloseAll(code, OrderSide.Sell);
        }

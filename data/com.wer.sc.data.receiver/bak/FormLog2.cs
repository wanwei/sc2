...
{
    public partial class FormLog2 : Form
    {
        private com.wer.sc.utils.LogUtils logUtils;

        private int textCount;

        public FormLog2(com.wer.sc.utils.LogUtils logUtils)
        {
            InitializeComponent();
            BindLogUtils(logUtils);
        }

        private void BindLogUtils(com.wer.sc.utils.LogUtils logUtils)
        {

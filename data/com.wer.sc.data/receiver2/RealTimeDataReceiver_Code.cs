...
namespace com.wer.sc.data.receiver2
{
    ...
    public class RealTimeDataReceiver_Code : IRealTimeDataReader
    {
        ...
        public RealTimeDataReceiver_Code(string code, int date, DataReaderFactory2 dataReaderFactory, int lastOpenDate, List<KLinePeriod> periods, List<double[]> openTime)
        {
            this.code = code;
            this.date = date;

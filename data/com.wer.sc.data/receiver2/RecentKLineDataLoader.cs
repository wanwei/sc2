...
namespace com.wer.sc.data.receiver2
{
    ...
    public class RecentKLineDataLoader
    {
        ...
        public RecentKLineDataLoader(DataReaderFactory2 dataReaderFactory)
        {
        ...
        /// <returns></returns>
        private int GetFirstDate(DataReaderFactory2 dataReaderFactory, int lastDate, KLinePeriod period)
        {

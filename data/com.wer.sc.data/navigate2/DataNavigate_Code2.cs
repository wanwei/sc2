...
namespace com.wer.sc.data.navigate
{
    ...
    /// 数据导航实现类
    /// </summary>
    public class DataNavigate_Code2 : IDataNavigate_Code
    {
        ...
        public DataNavigate_Code2(IDataPackage_Code dataPackage, double time)
        {
        ...
        {
            return GetTickData_Extend();
        }

        public ITickData_Extend GetTickData_Extend()
        {

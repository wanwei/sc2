...
{
    public class InstrumentReader : IInstrumentReader
    {
        ...
        internal InstrumentReader(IInstrumentStore instrumentStore)
        {
        ...
        public List<String> GetInstrumentsByCatelog(String catelog)
        {

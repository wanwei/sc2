...
namespace com.wer.sc.data.forward
{
    ...
    /// 该类用于数据的tick前进
    /// </summary>
    internal class HistoryDataForward_Code_TickPeriod : IDataNavigater_Code
    {
        ...
        public void AttachOtherData(string code, ReferedPeriods referedPeriods)
        {
        ...
        {
            if (OnTick != null)
                OnTick(this, new ForwardOnTickArgument(currentTickData, currentTickData.BarPos));
        }

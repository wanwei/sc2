...
{
    class DataForward_AttachCode_Tick : IRealTimeData_Code
    {
        private double time;
        ...
        private void ForwardToday_KLine(IKLineData_RealTime klineData, double time, ITickData tickData, int prevTickIndex)
        {
            ...
            int nextKLineIndex = DataForward_Code_Tick2.FindNextKLineIndex(klineData, time);
        ...
        private void ForwardToday_TimeLine(ITimeLineData_RealTime timeLineData, double time, ITickData tickData, int prevTickIndex)
        {
            if (timeLineData == null)
                return;
            int nextTimeLineIndex = DataForward_Code_Tick2.FindNextTimeLineIndex(timeLineData, time);
        ...
        {
            DataForward_Code_Tick2.ForwardNextDay(this.dataForForward, tradingDay);
        }

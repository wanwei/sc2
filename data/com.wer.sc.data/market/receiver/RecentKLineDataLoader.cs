...
namespace com.wer.sc.data.market.receiver
{
    ...
    public class RecentKLineDataLoader
    {
        ...
        public RecentKLineDataLoader(IDataReader dataReader)
        {
        ...
        {
            return dataReader.KLineDataReader.GetData(code, GetFirstDate(dataReader, lastOpenDate, period), lastOpenDate, period);
        }

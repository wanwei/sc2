...
namespace com.wer.sc.data.market.data
{
    ...
    /// 实时K线数据
    /// </summary>
    public class KLineData_RealTime : KLineData
    {
        ...
        public KLineData_RealTime(IKLineData historyKLineData, List<double> todayKlineTimeList, KLinePeriod period) : base(todayKlineTimeList.Count)
        {
            this.Period = period;

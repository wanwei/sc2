...
namespace com.wer.sc.plugin.historydata.utils
{
    ...
    public class TradingSessionDetailUtils
    {
        ...
        //public TradingSessionDetailUtils(String configPath) : this(configPath, new DataProvider_CodeInfo(configPath))
        //{
        //}

        //public TradingSessionDetailUtils(String configPath, DataProvider_CodeInfo provider_CodeInfo)
        //{            
        ...
        {
            //return GetOpenTime(GetCodeMarket(code), GetVariety(code), date);
            return null;
        }
    ...
    public class OpenTimeMarket
    {
        ...
        public TradingSessionDetailUtils Config;

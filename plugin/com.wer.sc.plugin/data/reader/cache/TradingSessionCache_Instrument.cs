...
namespace com.wer.sc.data.reader.cache
{
    ...
    /// 开盘时间的缓存实现
    /// </summary>
    public class TradingSessionCache_Instrument : ITradingSessionReader_Instrument
    {
        ...
        public TradingSessionCache_Instrument(string instrumentId, List<TradingSession> tradingSessionList)
        {
        ...
        private ITradingDayReader GetTradingDayCache()
        {
            if (tradingDayCache == null)
                tradingDayCache = new TradingDayCache(tradingDays);

...
namespace com.wer.sc.data.reader.cache
{
    ...
    {
        private static TradingDayCache tradingDayCache;

        private static TradingDayCache GetTradingDayCache()
        {
            ...
            tradingDayCache = new TradingDayCache(openDates);
            return tradingDayCache;
        }
        ...
        {
            TradingDayCache cache = GetTradingDayCache();

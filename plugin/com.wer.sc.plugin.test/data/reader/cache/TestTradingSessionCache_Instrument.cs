...
namespace com.wer.sc.data.reader.cache
{
    ...
    public class TestTradingSessionCache_Instrument
    {
        ...
        private TradingSessionCache_Instrument GetTradingSessionCache_Instrument(string code)
        {
            return new TradingSessionCache_Instrument(code, MockDataLoader.GetTradingSessions(code));
        ...
        {
            ITradingSessionReader_Instrument reader = GetTradingSessionCache_Instrument("M05");

...
{
    public class DataLoader_JinShuYuan : DataLoader_Abstract
    {
        private DataLoader_TickData dataLoader_TickData;

        private DataLoader_TradingDay dataLoader_TradingDay;

        public DataLoader_JinShuYuan(PluginHelper pluginHelper, string srcDataPath) : base(pluginHelper, srcDataPath)
        {

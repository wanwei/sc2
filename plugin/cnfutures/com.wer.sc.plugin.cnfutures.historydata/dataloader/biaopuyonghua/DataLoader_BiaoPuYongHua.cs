...
{
    public class DataLoader_BiaoPuYongHua : DataLoader_Abstract
    {
        private DataLoader_TickData dataLoader_TickData;

        private DataLoader_TradingDay dataLoader_TradingDay;

        public DataLoader_BiaoPuYongHua(PluginHelper pluginHelper, string srcDataPath) : base(pluginHelper, srcDataPath)
        {

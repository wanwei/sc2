...
namespace com.wer.sc.comp.graphic.main
{
    ...
    public class GraphicOperator_Main : IGraphicOperator_Main
    {
        ...
        public void RunModel(IPlugin_KLineModel model)
        {

        }

        public void RunModel(IPlugin_KLineModel model, IKLineData data)
        {
            this.klineData = data;
        ...
        public void RunModel(IPlugin_KLineModel model, string code, int start, int end, KLinePeriod period)
        {
        ...
        private void ModelRunedHandler(KLineModelRunArgs args)
        {
            ...
            IPlugin_KLineModel model = runner.Model;

...
{
    public abstract class GraphicDrawer_Real_Abstract : GraphicDrawer_Abstract
    {
        private IGraphicDrawer_Chart_TimeLine dataProvider;

        public IGraphicDrawer_Chart_TimeLine DataProvider
        {
            get
            {
                return dataProvider;

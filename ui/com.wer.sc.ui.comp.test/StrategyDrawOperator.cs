...
{
    public class StrategyDrawOperator : IDrawOperator
    {
        ...
        private CompChartDrawer2 compChart;
        ...
        //public StrategyDrawOperator(CompChartDrawer2 compChart)
        //{
        //    this.compChart = compChart;
        //}

        public StrategyDrawOperator(CompChartDrawer2 compChart, Dictionary<KLinePeriod, int> startPos_KLine, int startPos_TimeLine, int startPos_Tick)
        {
            this.compChart = compChart;
        ...
        public IStrategyDrawer GetDrawer_KLine(KLinePeriod klinePeriod)
        {
            ...
            IStrategyDrawer drawer = new StrategyDrawer(compChart.Drawer_PriceRect, compChart.GraphicData_Candle, compChart.GraphicMapping, startPos);

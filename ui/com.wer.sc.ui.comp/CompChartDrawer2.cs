...
{
    public class CompChartDrawer2
    {
        private CompData compData;

        private CompDataController compDataController;
        ...
        public CompChartDrawer2(Control control, CompDataController compDataController)
        {
            this.control = control;
            this.compDataController = compDataController;
            this.compData = compDataController.CompData;
            this.compDataController.OnDataChanged += CompDataController_OnDataChanged;
            this.Init();
        }

        private void CompDataController_OnDataChanged(object sender, CompDataChangeArgument arg)
        {
            this.RePaint();
        }

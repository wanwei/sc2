...
namespace com.wer.sc.ui.comp
{
    ...
    public class CompData
    {
        ...
        public CompData(string code, double time, KLinePeriod klinePeriod, int showKLineIndex)
        {
            this.code = code;
            this.time = time;
        ...
        public CompData(CompData compData)
        {
        ...
        public Object Clone()
        {
            CompData compData = new CompData(this.code, this.time, this.klinePeriod, this.showKLineIndex);
            compData.chartType = this.chartType;
            return compData;
        }

        public void CopyFrom(CompData compData)
        {
            this.code = compData.code;
            this.time = compData.time;
            this.klinePeriod = compData.klinePeriod;
